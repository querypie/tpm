#!/usr/bin/env python3
"""
CSV 파일에서 사용자 정보를 읽고 API를 통해 역할을 할당하는 프로그램
"""
...
import argparse
import logging
from role_assigner import process_role_assignment
...
def main():
    ...
    # 명령행 인자 파싱
    parser = argparse.ArgumentParser(description='CSV 파일에서 사용자 정보를 읽고 API를 통해 역할을 할당합니다.')
    ...
    # CSV 처리 시작
    success = process_role_assignment(args.csv_file, args.api_url, args.api_key)

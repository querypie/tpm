#!/usr/bin/env python3
"""
CSV 파일에서 서버 그룹 정보를 읽고 API를 통해 정책 및 역할을 생성하는 프로그램
"""
...
import argparse
import logging
from policy_processor import process_policies_from_csv
...
def main():
    ...
    # 명령행 인자 파싱
    parser = argparse.ArgumentParser(description='CSV 파일에서 서버 그룹 정보를 읽고 API를 통해 정책 및 역할을 생성합니다.')
    ...
    # CSV 처리 시작
    success = process_policies_from_csv(args.csv_file, args.api_url, args.api_key)

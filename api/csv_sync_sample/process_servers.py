#!/usr/bin/env python3
"""
CSV 파일에서 서버 정보를 읽고 API를 통해 서버, 서버 그룹 및 계정을 등록하는 프로그램
"""
...
import argparse
import logging
from server_processor import process_server_csv
...
def main():
    ...
    # 명령행 인자 파싱
    parser = argparse.ArgumentParser(description='CSV 파일에서 서버 정보를 읽고 API를 통해 서버, 서버 그룹 및 계정을 등록합니다.')
    ...
    # CSV 처리 시작
    success = process_server_csv(args.csv_file, args.api_url, args.api_key)
